...
export default function HospitalList() {
  ...
  useEffect(() => {
    if (!auth || !googleProvider || !isPreviewEnv) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (error.code === 'auth/account-exists-with-different-credential') {
        description = 'This email is already linked to another account method.';
      } else if (error.code === 'auth/popup-closed-by-user') {
        description = 'Popup was closed before completing sign-in.';
      }
      toast({
        variant: 'destructive',
        title: 'Login Failed',
